...
#
#' Read the documents on the github page https://github.com/maxlcummins/BLASTlord for more info
#' @param file Filename of your blast input
...
blastlord <- function(file, output, identity = 90, length = 90, writecsv = FALSE) {
  ...
  # Generates a table showing co-occurence of all genes on a given scaffold for each sample.
  file5 <- file1 %>%
    group_by(sample_name, scaffold) %>%
